...
export const ExperienceScreen = memo(({ setSection }) => {

  const { ref } = useSection('experience', setSection)


  return (
    <>
      <h3 className="my-4 ml-8 text-2xl font-bold">Experience</h3>
      <div className="flex w-auto py-20 pt-12 h-100 align-center" id='experience'>
        <section ref={ref} className="flex content-center w-full h-full text-gray-400 body-font">
